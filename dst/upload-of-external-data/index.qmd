...
https://www.dst.dk/da/TilSalg/Forskningsservice/Data/dataindsendelse (both in Danish and in English)
...
All users have access to this service in f5 dynamic webtop with project login. It is possible to upload the data by yourself or you can contact either Marie Kempf Frydendahl or Kasper Norman and we will support you. Guidelines for FSE-upload can be found:

https://www.dst.dk/Site/Dst/SingleFiles/GetArchiveFile.aspx?fi=3942639397&fo=0&ext=forskning (only in Danish)
...
The number of files should be kept to a minimum, which will speed up handling time and lower costs.
