...
---
SDS has a broad range of national registries that can be used for research and development of quality in healthcare.
You can apply for relevant registers for your project at Statistics Denmark.
Registers listet in the project database you can get access to without an additional cost, while register not in the projectdatabase you have to pay separately to SDS and DST for moving the data. Whether the registers is a part of the project database or not you have to make a application to SDS.  
