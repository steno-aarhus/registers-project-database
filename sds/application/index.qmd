...
Registers listet in the project database you can get access to without an additional cost, while register not in the projectdatabase you have to pay separately to DHDA and DST for moving the data. Whether the registers is a part of the project database or not you have to make a application to DHDA. 
...
If the data you apply for is a part of SDCA projekct database you must check both "**Godkendelse til genanvendelse**" and "**Samkørsel med Danmarks Statistik**" in the application form. In that case you also have to make it clear that is is SDCA project database 709627 af DST.  
...
This guide describes how to apply to SDS for access to drug data 
from the LMDB (Drug Database) via Statistics Denmark.

[Application to LMDB](https://sundhedsdatastyrelsen.dk/media/16357/Vejledning_Adgang_laegemiddeldata_DST.pdf)

In the guide you can also find a link to further describtion on the ATC-system to klassification of the drugs. 
