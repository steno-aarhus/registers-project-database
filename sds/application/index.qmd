...
If the data you apply for is a part of SDCA project database you must check both "**Godkendelse til genanvendelse**" and "**Samkørsel med Danmarks Statistik**" in the application form. In that case you also have to make it clear that is is SDCA project database 709627 af DST.  
