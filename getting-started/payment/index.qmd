...
## Basic cost for all projects 
  ...
  -  Basic fee for setting up a new project:  3.348 Dkr.
...
In addition to the costs mentioned, there are costs associated with uploading your own data, special requests for data, etc.
