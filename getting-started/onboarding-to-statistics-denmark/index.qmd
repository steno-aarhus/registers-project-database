...
To get access you need an affiliation agreement to SDCA's authorization at DST (aut. 574). If you previously have been a registered user at Statistics Denmark, you can use your DST ident from there. Otherwise we need the following information to get you registred:
...
When your affiliation agreement is approved you will receive an email with information on how to log in for the first time. You can also find relevant instructions here:

[Guide to logging in](https://www.dst.dk/da/TilSalg/data-til-forskning/analyseplatform/forskermaskinen)

When logged in to Remote.dst.dk you can log in to Danmarks Datavindue - DDV. Read more about how to log in to DDV for the first time here:

[Login Danmarks Datavindue](https://www.dst.dk/da/TilSalg/data-til-forskning/brugeradgang/login-i-danmarks-datavindue)
...
When you have passed the certification you can get access to a specific project at Statistics Denmark's server.
