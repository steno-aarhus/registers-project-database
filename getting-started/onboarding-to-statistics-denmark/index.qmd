...
In addition to this, you will need a short introduction from one of us about data security when working with microdata at Statistics Denmark. Here you can also help to log on for the first time. 

## Access to Statistics Denmarks 

When your affiliation agreement is approved you will recieve an email with information on how to log in for the first time. When logged in to Remote.dst.dk you can log in to Danmarks Datavindue - DDV. Read more about how to log in to DDV for the first time: 
...
When you have passed the certification you can get access to a specific project at Statistic Denmarks server. 
