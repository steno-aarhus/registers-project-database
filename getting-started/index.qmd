...
It gives the possible to get access to a broad range of registerdata from e.g.
Statistics Denmark, the Danish health data authorities and other datasources
...
If the purpose of your study do not fits under some of the existing projects in the project database you can set up your own project under the project database (given that your purpose is aligned with the overall purpose). On this page you can find information on preliminary procedure according to setting up a project. 
