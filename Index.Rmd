...
The sidebar contains information on the Project Database at SDCA as well as guidelines for setting up a project under the Project Database.
...
All users needs an affiliation at SDCA for direct access (not necessarily paid employment) and needs to have an active access to Statistics Denmark. For help please contact Datamanager in Tværs Marie Frydendahl, maipee@rm.dk
